        ...
        <div className="text-center mb-8">
          ...
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> This page can only be accessed once. Please
              save your order details for future reference.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            <Link
              href="/"
              onClick={() => {
                // Clear order data when user clicks continue shopping
        ...
        <div className="text-center mt-8 p-6 bg-white rounded-lg border">
          ...
          <p className="text-sm text-gray-600 mb-4">
            ...
            to help. Please reference your order number:{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            <Button variant="outline" size="sm" asChild>
              <Link
                href="/support"
                onClick={() => {
                  // Clear order data when user clicks contact support
                  sessionStorage.removeItem("guestOrderData");
                }}
              >
                Contact Support
